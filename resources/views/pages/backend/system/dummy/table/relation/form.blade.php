<div class="form-group row">
  ...
  <div class="col-lg-9">
    {!! Form::select('id_general', dummy_table_generals(), (isset($data->id_general) ? $data->id_general : NULL), ['placeholder' => '- Select ID General -', 'class' => 'form-control', 'required' => 'required']) !!}
