...
class RelationController extends Controller {
  ...
  **/
  ...
  public function __construct() {
    ...
    $this->url = '/dashboard/dummy/tables/relations';
    $this->path = 'pages.backend.system.dummy.table.relation.';
    $this->model = 'App\Models\Backend\System\Dummy\Table\Relation';
  ...
  **/
  ...
  public function index() {
    ...
    if(request()->ajax()) {
      ...
      ->editColumn('id_generals', function($order) { return $order->dummy_table_generals->name; })
